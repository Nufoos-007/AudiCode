        ...
        <div className="rounded-xl border border-border bg-card p-8">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 h-11 rounded-md border border-border bg-background text-sm font-medium text-foreground hover:bg-muted transition-colors disabled:opacity-50"
            >
              ...
              {loading && authProvider === "google" ? "Signing in..." : "Continue with Google"}
            </button>
            ...
            >
              ...
              {loading && authProvider === "github" ? "Signing in..." : "Continue with GitHub"}
            </button>
          </div>
